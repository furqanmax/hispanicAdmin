                                        ...
                                        <form method="POST" action="{{route('subscription.update', $subscription->id)}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        ...
                                                        <input type="text" class="form-control" name="title_en"  value="{{$subscription->title_en}}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        ...
                                                        <input type="text" class="form-control" name="title_sp" value= "{{$subscription->title_sp}}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <p>Credit</p>
                                                        <input type="number" class="form-control" name="credits" value="{{$subscription->credits}}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <p>Monthly Price</p>
                                                        <input type="number" class="form-control" name="monthly_price" value="{{$subscription->monthly_price}}" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <p>Yearly Price</p>
                                                        <input type="number" class="form-control" name="yearly_price" value="{{$subscription->yearly_price}}" />
                                                    </div>
                                                </div>
                                            </div>
